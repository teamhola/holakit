...
export class HolaInput {
   ...
   */
  @Prop() type: ('date' | 'email' | 'number' | 'password' | 'search' | 'tel' | 'text' | 'url' | 'time') = 'text';
   ...
   */
  @Event() holaInput!: EventEmitter<KeyboardEvent>;

  /**
   * Emitted when the value has changed.
   */
  @Event() holaChange!: EventEmitter<{ value: string }>;

  /**
   * Emitted when the input loses focus.
   */
  @Event() holaBlur!: EventEmitter<void>;

  /**
   * Emitted when the input has focus.
   */
  @Event() holaFocus!: EventEmitter<void>;

  /**
   * Emitted when the input has been created.
   */
  @Event() holaInputDidLoad!: EventEmitter<void>;

  /**
   * Emitted when the input has been removed.
   */
  @Event() holaInputDidUnload!: EventEmitter<void>;
  ...
  private onInput = (ev: Event) => {
    ...
    this.holaInput.emit(ev as KeyboardEvent);
  }
